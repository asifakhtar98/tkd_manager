...
/// Globally unique identifier (UUID v4).
 ...
 String get name; String get dateRange; String get venue; String get organizer; String get ageCategoryLabel; String get genderLabel; String get weightDivisionLabel;/// URL of the left-side logo displayed in the tie sheet header.
/// Defaults to India Taekwondo federation logo.
 String get leftLogoUrl;/// URL of the right-side logo displayed in the tie sheet header.
/// Defaults to World Taekwondo federation logo.
 String get rightLogoUrl;/// Wall-clock time when this tournament was first created in-memory.
...
@useResult
$Res call({
 String id, String name, String dateRange, String venue, String organizer, String ageCategoryLabel, String genderLabel, String weightDivisionLabel, String leftLogoUrl, String rightLogoUrl, DateTime createdAt
});
...
/// Create a copy of TournamentEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? dateRange = null,Object? venue = null,Object? organizer = null,Object? ageCategoryLabel = null,Object? genderLabel = null,Object? weightDivisionLabel = null,Object? leftLogoUrl = null,Object? rightLogoUrl = null,Object? createdAt = null,}) {
...
as String,ageCategoryLabel: null == ageCategoryLabel ? _self.ageCategoryLabel : ageCategoryLabel // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String dateRange,  String venue,  String organizer,  String ageCategoryLabel,  String genderLabel,  String weightDivisionLabel,  String leftLogoUrl,  String rightLogoUrl,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TournamentEntity() when $default != null:
return $default(_that.id,_that.name,_that.dateRange,_that.venue,_that.organizer,_that.ageCategoryLabel,_that.genderLabel,_that.weightDivisionLabel,_that.leftLogoUrl,_that.rightLogoUrl,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String dateRange,  String venue,  String organizer,  String ageCategoryLabel,  String genderLabel,  String weightDivisionLabel,  String leftLogoUrl,  String rightLogoUrl,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _TournamentEntity():
return $default(_that.id,_that.name,_that.dateRange,_that.venue,_that.organizer,_that.ageCategoryLabel,_that.genderLabel,_that.weightDivisionLabel,_that.leftLogoUrl,_that.rightLogoUrl,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String dateRange,  String venue,  String organizer,  String ageCategoryLabel,  String genderLabel,  String weightDivisionLabel,  String leftLogoUrl,  String rightLogoUrl,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _TournamentEntity() when $default != null:
return $default(_that.id,_that.name,_that.dateRange,_that.venue,_that.organizer,_that.ageCategoryLabel,_that.genderLabel,_that.weightDivisionLabel,_that.leftLogoUrl,_that.rightLogoUrl,_that.createdAt);case _:
  return null;
...
class _TournamentEntity implements TournamentEntity {
  const _TournamentEntity({required this.id, required this.name, this.dateRange = '', this.venue = '', this.organizer = '', this.ageCategoryLabel = '', this.genderLabel = '', this.weightDivisionLabel = '', this.leftLogoUrl = 'https://lldlunqzkltclpfzpjxh.supabase.co/storage/v1/object/public/assets/India_Taekwondo_logo_5346.png', this.rightLogoUrl = 'https://lldlunqzkltclpfzpjxh.supabase.co/storage/v1/object/public/assets/World_Taekwondo+logo_356345.png', required this.createdAt});
...
/// Create a copy of TournamentEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? dateRange = null,Object? venue = null,Object? organizer = null,Object? ageCategoryLabel = null,Object? genderLabel = null,Object? weightDivisionLabel = null,Object? leftLogoUrl = null,Object? rightLogoUrl = null,Object? createdAt = null,}) {
