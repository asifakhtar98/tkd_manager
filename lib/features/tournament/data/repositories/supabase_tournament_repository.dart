...
class SupabaseTournamentRepository extends BaseSupabaseRepository implements TournamentRepository {
  ...
  Future<Either<Failure, List<TournamentEntity>>> getTournaments({int limit = 20, int offset = 0}) {
    return executeDbOperation(() async {
      ...
      return response.map((json) => TournamentModel.fromJson(json).toEntity()).toList();
