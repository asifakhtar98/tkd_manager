...
/// TBD placeholder text, and unresolved junction lines.
 Color get mutedColor;/// Resolved connector stroke colour (winner advancement lines).
 Color get connectorWonColor;// ── Canvas & card tokens ────────────────────────────────────────────────
/// Canvas background fill.
 Color get canvasBackgroundColor;/// Unified border stroke colour for cards, TBD outlines, and pending
/// dashed connectors.
 Color get borderColor;/// Shadow paint opacity multiplier (0.0 = no shadow, 1.0 = full shadow).
 double get shadowOpacityMultiplier;/// Uniform stroke width for all connector / junction lines.
...
/// Primary text colour (headings, names, numbers).
 Color get primaryTextColor;/// Secondary text colour (subtle / supporting text).
 Color get secondaryTextColor;/// When `true`, **every** text span is rendered bold regardless of
...
/// Participant card background fill.
 Color get rowFillColor;/// Info-row / sub-header background fill.
 Color get headerFillColor;/// TBD placeholder card background fill.
 Color get tbdFillColor;// ── Header banner ───────────────────────────────────────────────────────
/// Top banner background colour.
 Color get headerBannerBackgroundColor;/// Top banner text colour.
 Color get headerBannerTextColor;// ── Accent & badge tokens ───────────────────────────────────────────────
/// Participant row accent strip colour (left/right edge coloured strip).
 Color get participantAccentStripColor;/// Blue-corner badge colour.
 Color get blueCornerColor;/// Red-corner badge colour.
 Color get redCornerColor;// ── Section label tokens (DE brackets) ──────────────────────────────────
/// Winners bracket section-label colour.
 Color get winnersLabelColor;/// Losers bracket section-label colour.
 Color get losersLabelColor;// ── Medal table tokens ──────────────────────────────────────────────────
 Color get medalGoldFillColor; Color get medalSilverFillColor; Color get medalBronzeFillColor; Color get medalGoldTextColor; Color get medalSilverTextColor; Color get medalBronzeTextColor; Color get medalGoldAccentColor; Color get medalSilverAccentColor; Color get medalBronzeAccentColor;// ── Shape / radius tokens ───────────────────────────────────────────────
...
/// Width of each dash segment in dashed connector lines.
 ...
 double get dashedLineGapWidth;// ── Shadow tokens ───────────────────────────────────────────────────────
/// Default blur radius for card elevation shadows.
 double get shadowBlurRadius;/// Base colour for card elevation shadows (before opacity scaling).
 Color get shadowColor;/// Horizontal offset for card elevation shadows (px).
 double get shadowOffsetX;/// Vertical offset for card elevation shadows (px).
 double get shadowOffsetY;// ── Typography tokens ───────────────────────────────────────────────────
...
/// Minimum vertical span for center-final junction arms (px).
 ...
 double get grandFinalOutputArmLength;// ── Banner & logo layout tokens ─────────────────────────────────────────
...
/// Fill colour for match number pills.
 Color get matchPillFillColor;/// Text colour inside corner badges (B / R).
 Color get badgeTextColor;// ── Opacity tokens ──────────────────────────────────────────────────────
...
@useResult
$Res call({
 Color mutedColor, Color connectorWonColor, Color canvasBackgroundColor, Color borderColor, double shadowOpacityMultiplier, double connectorStrokeWidth, bool isInteractivityDisabled, Color primaryTextColor, Color secondaryTextColor, bool isTextForceBold, double fontSizeDelta, Color rowFillColor, Color headerFillColor, Color tbdFillColor, Color headerBannerBackgroundColor, Color headerBannerTextColor, Color participantAccentStripColor, Color blueCornerColor, Color redCornerColor, Color winnersLabelColor, Color losersLabelColor, Color medalGoldFillColor, Color medalSilverFillColor, Color medalBronzeFillColor, Color medalGoldTextColor, Color medalSilverTextColor, Color medalBronzeTextColor, Color medalGoldAccentColor, Color medalSilverAccentColor, Color medalBronzeAccentColor, double elementBorderRadius, double junctionCornerRadius, double borderStrokeWidth, double subtleStrokeWidth, double wonConnectorStrokeWidth, double canvasMargin, double sectionGapHeight, double accentStripWidth, double badgeMinRadius, double badgePadding, double matchPillMinHalfWidth, double matchPillHorizontalPadding, double matchPillMinHalfHeight, double matchPillVerticalPadding, double dashedLineDashWidth, double dashedLineGapWidth, double shadowBlurRadius, Color shadowColor, double shadowOffsetX, double shadowOffsetY, String fontFamily, double headerLetterSpacing, double subHeaderLetterSpacing, double rowHeight, double intraMatchGapHeight, double interMatchGapHeight, double numberColumnWidth, double nameColumnWidth, double registrationIdColumnWidth, double roundColumnWidth, double headerTotalHeight, double subHeaderRowHeight, double centerGapWidth, double sectionLabelHeight, double medalTableWidth, double medalRowHeight, double medalNameColumnWidth, double medalLabelColumnWidth, double medalRowGap, double centerFinalMinimumSpan, double grandFinalOutputArmLength, double headerBannerHeight, double logoMaxHeight, double logoPadding, Color matchPillFillColor, Color badgeTextColor, double sectionLabelBackgroundOpacity, double headerSecondaryTextOpacity, double badgeOutlineOpacity, double canvasMinimumWidth, double canvasMinimumHeight
});
...
as Color,shadowOpacityMultiplier: null == shadowOpacityMultiplier ? _self.shadowOpacityMultiplier : shadowOpacityMultiplier // ignore: cast_nullable_to_non_nullable
as double,connectorStrokeWidth: null == connectorStrokeWidth ? _self.connectorStrokeWidth : connectorStrokeWidth // ignore: cast_nullable_to_non_nullable
...
as double,shadowBlurRadius: null == shadowBlurRadius ? _self.shadowBlurRadius : shadowBlurRadius // ignore: cast_nullable_to_non_nullable
as double,shadowColor: null == shadowColor ? _self.shadowColor : shadowColor // ignore: cast_nullable_to_non_nullable
as Color,shadowOffsetX: null == shadowOffsetX ? _self.shadowOffsetX : shadowOffsetX // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Color mutedColor,  Color connectorWonColor,  Color canvasBackgroundColor,  Color borderColor,  double shadowOpacityMultiplier,  double connectorStrokeWidth,  bool isInteractivityDisabled,  Color primaryTextColor,  Color secondaryTextColor,  bool isTextForceBold,  double fontSizeDelta,  Color rowFillColor,  Color headerFillColor,  Color tbdFillColor,  Color headerBannerBackgroundColor,  Color headerBannerTextColor,  Color participantAccentStripColor,  Color blueCornerColor,  Color redCornerColor,  Color winnersLabelColor,  Color losersLabelColor,  Color medalGoldFillColor,  Color medalSilverFillColor,  Color medalBronzeFillColor,  Color medalGoldTextColor,  Color medalSilverTextColor,  Color medalBronzeTextColor,  Color medalGoldAccentColor,  Color medalSilverAccentColor,  Color medalBronzeAccentColor,  double elementBorderRadius,  double junctionCornerRadius,  double borderStrokeWidth,  double subtleStrokeWidth,  double wonConnectorStrokeWidth,  double canvasMargin,  double sectionGapHeight,  double accentStripWidth,  double badgeMinRadius,  double badgePadding,  double matchPillMinHalfWidth,  double matchPillHorizontalPadding,  double matchPillMinHalfHeight,  double matchPillVerticalPadding,  double dashedLineDashWidth,  double dashedLineGapWidth,  double shadowBlurRadius,  Color shadowColor,  double shadowOffsetX,  double shadowOffsetY,  String fontFamily,  double headerLetterSpacing,  double subHeaderLetterSpacing,  double rowHeight,  double intraMatchGapHeight,  double interMatchGapHeight,  double numberColumnWidth,  double nameColumnWidth,  double registrationIdColumnWidth,  double roundColumnWidth,  double headerTotalHeight,  double subHeaderRowHeight,  double centerGapWidth,  double sectionLabelHeight,  double medalTableWidth,  double medalRowHeight,  double medalNameColumnWidth,  double medalLabelColumnWidth,  double medalRowGap,  double centerFinalMinimumSpan,  double grandFinalOutputArmLength,  double headerBannerHeight,  double logoMaxHeight,  double logoPadding,  Color matchPillFillColor,  Color badgeTextColor,  double sectionLabelBackgroundOpacity,  double headerSecondaryTextOpacity,  double badgeOutlineOpacity,  double canvasMinimumWidth,  double canvasMinimumHeight)  $default,) {final _that = this;
switch (_that) {
case _TieSheetThemeConfig():
return $default(_that.mutedColor,_that.connectorWonColor,_that.canvasBackgroundColor,_that.borderColor,_that.shadowOpacityMultiplier,_that.connectorStrokeWidth,_that.isInteractivityDisabled,_that.primaryTextColor,_that.secondaryTextColor,_that.isTextForceBold,_that.fontSizeDelta,_that.rowFillColor,_that.headerFillColor,_that.tbdFillColor,_that.headerBannerBackgroundColor,_that.headerBannerTextColor,_that.participantAccentStripColor,_that.blueCornerColor,_that.redCornerColor,_that.winnersLabelColor,_that.losersLabelColor,_that.medalGoldFillColor,_that.medalSilverFillColor,_that.medalBronzeFillColor,_that.medalGoldTextColor,_that.medalSilverTextColor,_that.medalBronzeTextColor,_that.medalGoldAccentColor,_that.medalSilverAccentColor,_that.medalBronzeAccentColor,_that.elementBorderRadius,_that.junctionCornerRadius,_that.borderStrokeWidth,_that.subtleStrokeWidth,_that.wonConnectorStrokeWidth,_that.canvasMargin,_that.sectionGapHeight,_that.accentStripWidth,_that.badgeMinRadius,_that.badgePadding,_that.matchPillMinHalfWidth,_that.matchPillHorizontalPadding,_that.matchPillMinHalfHeight,_that.matchPillVerticalPadding,_that.dashedLineDashWidth,_that.dashedLineGapWidth,_that.shadowBlurRadius,_that.shadowColor,_that.shadowOffsetX,_that.shadowOffsetY,_that.fontFamily,_that.headerLetterSpacing,_that.subHeaderLetterSpacing,_that.rowHeight,_that.intraMatchGapHeight,_that.interMatchGapHeight,_that.numberColumnWidth,_that.nameColumnWidth,_that.registrationIdColumnWidth,_that.roundColumnWidth,_that.headerTotalHeight,_that.subHeaderRowHeight,_that.centerGapWidth,_that.sectionLabelHeight,_that.medalTableWidth,_that.medalRowHeight,_that.medalNameColumnWidth,_that.medalLabelColumnWidth,_that.medalRowGap,_that.centerFinalMinimumSpan,_that.grandFinalOutputArmLength,_that.headerBannerHeight,_that.logoMaxHeight,_that.logoPadding,_that.matchPillFillColor,_that.badgeTextColor,_that.sectionLabelBackgroundOpacity,_that.headerSecondaryTextOpacity,_that.badgeOutlineOpacity,_that.canvasMinimumWidth,_that.canvasMinimumHeight);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Color mutedColor,  Color connectorWonColor,  Color canvasBackgroundColor,  Color borderColor,  double shadowOpacityMultiplier,  double connectorStrokeWidth,  bool isInteractivityDisabled,  Color primaryTextColor,  Color secondaryTextColor,  bool isTextForceBold,  double fontSizeDelta,  Color rowFillColor,  Color headerFillColor,  Color tbdFillColor,  Color headerBannerBackgroundColor,  Color headerBannerTextColor,  Color participantAccentStripColor,  Color blueCornerColor,  Color redCornerColor,  Color winnersLabelColor,  Color losersLabelColor,  Color medalGoldFillColor,  Color medalSilverFillColor,  Color medalBronzeFillColor,  Color medalGoldTextColor,  Color medalSilverTextColor,  Color medalBronzeTextColor,  Color medalGoldAccentColor,  Color medalSilverAccentColor,  Color medalBronzeAccentColor,  double elementBorderRadius,  double junctionCornerRadius,  double borderStrokeWidth,  double subtleStrokeWidth,  double wonConnectorStrokeWidth,  double canvasMargin,  double sectionGapHeight,  double accentStripWidth,  double badgeMinRadius,  double badgePadding,  double matchPillMinHalfWidth,  double matchPillHorizontalPadding,  double matchPillMinHalfHeight,  double matchPillVerticalPadding,  double dashedLineDashWidth,  double dashedLineGapWidth,  double shadowBlurRadius,  Color shadowColor,  double shadowOffsetX,  double shadowOffsetY,  String fontFamily,  double headerLetterSpacing,  double subHeaderLetterSpacing,  double rowHeight,  double intraMatchGapHeight,  double interMatchGapHeight,  double numberColumnWidth,  double nameColumnWidth,  double registrationIdColumnWidth,  double roundColumnWidth,  double headerTotalHeight,  double subHeaderRowHeight,  double centerGapWidth,  double sectionLabelHeight,  double medalTableWidth,  double medalRowHeight,  double medalNameColumnWidth,  double medalLabelColumnWidth,  double medalRowGap,  double centerFinalMinimumSpan,  double grandFinalOutputArmLength,  double headerBannerHeight,  double logoMaxHeight,  double logoPadding,  Color matchPillFillColor,  Color badgeTextColor,  double sectionLabelBackgroundOpacity,  double headerSecondaryTextOpacity,  double badgeOutlineOpacity,  double canvasMinimumWidth,  double canvasMinimumHeight)?  $default,) {final _that = this;
switch (_that) {
case _TieSheetThemeConfig() when $default != null:
return $default(_that.mutedColor,_that.connectorWonColor,_that.canvasBackgroundColor,_that.borderColor,_that.shadowOpacityMultiplier,_that.connectorStrokeWidth,_that.isInteractivityDisabled,_that.primaryTextColor,_that.secondaryTextColor,_that.isTextForceBold,_that.fontSizeDelta,_that.rowFillColor,_that.headerFillColor,_that.tbdFillColor,_that.headerBannerBackgroundColor,_that.headerBannerTextColor,_that.participantAccentStripColor,_that.blueCornerColor,_that.redCornerColor,_that.winnersLabelColor,_that.losersLabelColor,_that.medalGoldFillColor,_that.medalSilverFillColor,_that.medalBronzeFillColor,_that.medalGoldTextColor,_that.medalSilverTextColor,_that.medalBronzeTextColor,_that.medalGoldAccentColor,_that.medalSilverAccentColor,_that.medalBronzeAccentColor,_that.elementBorderRadius,_that.junctionCornerRadius,_that.borderStrokeWidth,_that.subtleStrokeWidth,_that.wonConnectorStrokeWidth,_that.canvasMargin,_that.sectionGapHeight,_that.accentStripWidth,_that.badgeMinRadius,_that.badgePadding,_that.matchPillMinHalfWidth,_that.matchPillHorizontalPadding,_that.matchPillMinHalfHeight,_that.matchPillVerticalPadding,_that.dashedLineDashWidth,_that.dashedLineGapWidth,_that.shadowBlurRadius,_that.shadowColor,_that.shadowOffsetX,_that.shadowOffsetY,_that.fontFamily,_that.headerLetterSpacing,_that.subHeaderLetterSpacing,_that.rowHeight,_that.intraMatchGapHeight,_that.interMatchGapHeight,_that.numberColumnWidth,_that.nameColumnWidth,_that.registrationIdColumnWidth,_that.roundColumnWidth,_that.headerTotalHeight,_that.subHeaderRowHeight,_that.centerGapWidth,_that.sectionLabelHeight,_that.medalTableWidth,_that.medalRowHeight,_that.medalNameColumnWidth,_that.medalLabelColumnWidth,_that.medalRowGap,_that.centerFinalMinimumSpan,_that.grandFinalOutputArmLength,_that.headerBannerHeight,_that.logoMaxHeight,_that.logoPadding,_that.matchPillFillColor,_that.badgeTextColor,_that.sectionLabelBackgroundOpacity,_that.headerSecondaryTextOpacity,_that.badgeOutlineOpacity,_that.canvasMinimumWidth,_that.canvasMinimumHeight);case _:
  return null;
...
class _TieSheetThemeConfig extends TieSheetThemeConfig {
  const _TieSheetThemeConfig({required this.mutedColor, required this.connectorWonColor, required this.canvasBackgroundColor, required this.borderColor, required this.shadowOpacityMultiplier, required this.connectorStrokeWidth, required this.isInteractivityDisabled, required this.primaryTextColor, required this.secondaryTextColor, required this.isTextForceBold, required this.fontSizeDelta, required this.rowFillColor, required this.headerFillColor, required this.tbdFillColor, required this.headerBannerBackgroundColor, required this.headerBannerTextColor, required this.participantAccentStripColor, required this.blueCornerColor, required this.redCornerColor, required this.winnersLabelColor, required this.losersLabelColor, required this.medalGoldFillColor, required this.medalSilverFillColor, required this.medalBronzeFillColor, required this.medalGoldTextColor, required this.medalSilverTextColor, required this.medalBronzeTextColor, required this.medalGoldAccentColor, required this.medalSilverAccentColor, required this.medalBronzeAccentColor, required this.elementBorderRadius, required this.junctionCornerRadius, required this.borderStrokeWidth, required this.subtleStrokeWidth, required this.wonConnectorStrokeWidth, required this.canvasMargin, required this.sectionGapHeight, required this.accentStripWidth, required this.badgeMinRadius, required this.badgePadding, required this.matchPillMinHalfWidth, required this.matchPillHorizontalPadding, required this.matchPillMinHalfHeight, required this.matchPillVerticalPadding, required this.dashedLineDashWidth, required this.dashedLineGapWidth, required this.shadowBlurRadius, required this.shadowColor, required this.shadowOffsetX, required this.shadowOffsetY, required this.fontFamily, required this.headerLetterSpacing, required this.subHeaderLetterSpacing, required this.rowHeight, required this.intraMatchGapHeight, required this.interMatchGapHeight, required this.numberColumnWidth, required this.nameColumnWidth, required this.registrationIdColumnWidth, required this.roundColumnWidth, required this.headerTotalHeight, required this.subHeaderRowHeight, required this.centerGapWidth, required this.sectionLabelHeight, required this.medalTableWidth, required this.medalRowHeight, required this.medalNameColumnWidth, required this.medalLabelColumnWidth, required this.medalRowGap, required this.centerFinalMinimumSpan, required this.grandFinalOutputArmLength, required this.headerBannerHeight, required this.logoMaxHeight, required this.logoPadding, required this.matchPillFillColor, required this.badgeTextColor, required this.sectionLabelBackgroundOpacity, required this.headerSecondaryTextOpacity, required this.badgeOutlineOpacity, required this.canvasMinimumWidth, required this.canvasMinimumHeight}): super._();
  

// ── Connector / junction tokens ─────────────────────────────────────────
/// Muted colour used for generic connectors, BYE dashed lines,
/// TBD placeholder text, and unresolved junction lines.
@override final  Color mutedColor;
/// Resolved connector stroke colour (winner advancement lines).
@override final  Color connectorWonColor;
// ── Canvas & card tokens ────────────────────────────────────────────────
/// Canvas background fill.
...
@override final  double shadowOpacityMultiplier;
...
// ── Text tokens ─────────────────────────────────────────────────────────
/// Primary text colour (headings, names, numbers).
@override final  Color primaryTextColor;
/// Secondary text colour (subtle / supporting text).
@override final  Color secondaryTextColor;
...
// ── Fill tokens ─────────────────────────────────────────────────────────
/// Participant card background fill.
@override final  Color rowFillColor;
/// Info-row / sub-header background fill.
@override final  Color headerFillColor;
/// TBD placeholder card background fill.
@override final  Color tbdFillColor;
// ── Header banner ───────────────────────────────────────────────────────
/// Top banner background colour.
@override final  Color headerBannerBackgroundColor;
/// Top banner text colour.
@override final  Color headerBannerTextColor;
// ── Accent & badge tokens ───────────────────────────────────────────────
/// Participant row accent strip colour (left/right edge coloured strip).
@override final  Color participantAccentStripColor;
/// Blue-corner badge colour.
@override final  Color blueCornerColor;
/// Red-corner badge colour.
@override final  Color redCornerColor;
// ── Section label tokens (DE brackets) ──────────────────────────────────
/// Winners bracket section-label colour.
@override final  Color winnersLabelColor;
/// Losers bracket section-label colour.
@override final  Color losersLabelColor;
// ── Medal table tokens ──────────────────────────────────────────────────
@override final  Color medalGoldFillColor;
@override final  Color medalSilverFillColor;
@override final  Color medalBronzeFillColor;
@override final  Color medalGoldTextColor;
@override final  Color medalSilverTextColor;
@override final  Color medalBronzeTextColor;
@override final  Color medalGoldAccentColor;
@override final  Color medalSilverAccentColor;
@override final  Color medalBronzeAccentColor;
// ── Shape / radius tokens ───────────────────────────────────────────────
/// Unified border radius applied to all rectangular UI elements.
...
// ── Shadow tokens ───────────────────────────────────────────────────────
/// Default blur radius for card elevation shadows.
@override final  double shadowBlurRadius;
...
/// Fill colour for match number pills.
@override final  Color matchPillFillColor;
/// Text colour inside corner badges (B / R).
@override final  Color badgeTextColor;
// ── Opacity tokens ──────────────────────────────────────────────────────
/// Background opacity for section label fill (0.0–1.0).
