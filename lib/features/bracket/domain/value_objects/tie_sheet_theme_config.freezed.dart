...
/// dashed connectors.
@ColorJsonConverter() Color get borderColor;/// Shadow paint opacity multiplier (0.0 = no shadow, 1.0 = full shadow).
...
@ColorJsonConverter() Color get shadowColor;/// Horizontal offset for card elevation shadows (px).
...
@override@ColorJsonConverter() final  Color shadowColor;
