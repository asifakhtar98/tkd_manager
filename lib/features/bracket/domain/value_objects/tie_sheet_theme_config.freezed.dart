...
@ColorJsonConverter() Color get losersLabelColor;@ColorJsonConverter() Color get medalGoldFillColor;@ColorJsonConverter() Color get medalSilverFillColor;@ColorJsonConverter() Color get medalBronzeFillColor;@ColorJsonConverter() Color get medalGoldTextColor;@ColorJsonConverter() Color get medalSilverTextColor;@ColorJsonConverter() Color get medalBronzeTextColor;@ColorJsonConverter() Color get medalGoldAccentColor;@ColorJsonConverter() Color get medalSilverAccentColor;@ColorJsonConverter() Color get medalBronzeAccentColor;/// Primary stroke width for borders, outlines, dividers, and pending
/// connector lines.
 ...
 double get accentStripWidth;/// Minimum half-size for square corner badges (B / R).
 double get badgeMinHalfSize;/// Padding added around badge text to compute dynamic radius.
...
@ColorJsonConverter() Color get badgeTextColor;/// Background opacity for section label fill (0.0–1.0).
 ...
 double get canvasMinimumHeight;// ── Header text positioning (inside banner) ────────────────────────────
/// Top padding of the tournament title text inside the header banner (px).
 double get headerTitleTopPadding;/// Vertical offset of the subtitle (date/venue) line from the banner top (px).
 double get headerSubtitleTopOffset;/// Vertical offset of the organiser line from the banner top (px).
 double get headerOrganizerTopOffset;/// Gap between the header banner bottom edge and the info row (px).
 double get headerBannerBottomGap;// ── Layout gaps & spacers ──────────────────────────────────────────────
/// Gap between the sub-header info row and the bracket table (px).
 double get headerToTableGap;/// Gap between a section label bar and the R1 rows beneath it (DE, px).
 double get sectionLabelToTableGap;/// Gap between losers bracket bottom and the medal table (DE only, px).
 double get deCanvasBracketToMedalGap;/// Fine-tune vertical offset for the medal table position (px).
 double get medalTableTopPadding;/// Extra horizontal padding added to the DE canvas width calculation (px).
 double get deCanvasExtraWidthPadding;// ── Info row sizing ────────────────────────────────────────────────────
/// Vertical inset for column dividers inside the classification info row (px).
 double get classificationDividerInset;// ── Base font sizes ────────────────────────────────────────────────────
/// Base font size for the tournament title (before fontSizeDelta scaling).
 double get headerTitleBaseFontSize;/// Base font size for the subtitle line (date/venue, before fontSizeDelta).
 double get headerSubtitleBaseFontSize;/// Base font size for the organiser line (before fontSizeDelta scaling).
 double get headerOrganizerBaseFontSize;/// Base font size for match number pill text (before fontSizeDelta scaling).
 double get matchPillBaseFontSize;
...
as Color,borderStrokeWidth: null == borderStrokeWidth ? _self.borderStrokeWidth : borderStrokeWidth // ignore: cast_nullable_to_non_nullable
...
as double,badgeMinHalfSize: null == badgeMinHalfSize ? _self.badgeMinHalfSize : badgeMinHalfSize // ignore: cast_nullable_to_non_nullable
...
as double,headerTitleTopPadding: null == headerTitleTopPadding ? _self.headerTitleTopPadding : headerTitleTopPadding // ignore: cast_nullable_to_non_nullable
as double,headerSubtitleTopOffset: null == headerSubtitleTopOffset ? _self.headerSubtitleTopOffset : headerSubtitleTopOffset // ignore: cast_nullable_to_non_nullable
as double,headerOrganizerTopOffset: null == headerOrganizerTopOffset ? _self.headerOrganizerTopOffset : headerOrganizerTopOffset // ignore: cast_nullable_to_non_nullable
as double,headerBannerBottomGap: null == headerBannerBottomGap ? _self.headerBannerBottomGap : headerBannerBottomGap // ignore: cast_nullable_to_non_nullable
as double,headerToTableGap: null == headerToTableGap ? _self.headerToTableGap : headerToTableGap // ignore: cast_nullable_to_non_nullable
as double,sectionLabelToTableGap: null == sectionLabelToTableGap ? _self.sectionLabelToTableGap : sectionLabelToTableGap // ignore: cast_nullable_to_non_nullable
as double,deCanvasBracketToMedalGap: null == deCanvasBracketToMedalGap ? _self.deCanvasBracketToMedalGap : deCanvasBracketToMedalGap // ignore: cast_nullable_to_non_nullable
as double,medalTableTopPadding: null == medalTableTopPadding ? _self.medalTableTopPadding : medalTableTopPadding // ignore: cast_nullable_to_non_nullable
as double,deCanvasExtraWidthPadding: null == deCanvasExtraWidthPadding ? _self.deCanvasExtraWidthPadding : deCanvasExtraWidthPadding // ignore: cast_nullable_to_non_nullable
as double,classificationDividerInset: null == classificationDividerInset ? _self.classificationDividerInset : classificationDividerInset // ignore: cast_nullable_to_non_nullable
as double,headerTitleBaseFontSize: null == headerTitleBaseFontSize ? _self.headerTitleBaseFontSize : headerTitleBaseFontSize // ignore: cast_nullable_to_non_nullable
as double,headerSubtitleBaseFontSize: null == headerSubtitleBaseFontSize ? _self.headerSubtitleBaseFontSize : headerSubtitleBaseFontSize // ignore: cast_nullable_to_non_nullable
as double,headerOrganizerBaseFontSize: null == headerOrganizerBaseFontSize ? _self.headerOrganizerBaseFontSize : headerOrganizerBaseFontSize // ignore: cast_nullable_to_non_nullable
as double,matchPillBaseFontSize: null == matchPillBaseFontSize ? _self.matchPillBaseFontSize : matchPillBaseFontSize // ignore: cast_nullable_to_non_nullable
as double,
  ));
}
...
@override final  double badgeMinHalfSize;
