...
_TieSheetThemeConfig _$TieSheetThemeConfigFromJson(
  ...
  elementBorderRadius: (json['elementBorderRadius'] as num).toDouble(),
  junctionCornerRadius: (json['junctionCornerRadius'] as num).toDouble(),
  ...
  badgeMinRadius: (json['badgeMinRadius'] as num).toDouble(),
...
Map<String, dynamic> _$TieSheetThemeConfigToJson(
  ...
  'elementBorderRadius': instance.elementBorderRadius,
  'junctionCornerRadius': instance.junctionCornerRadius,
  ...
  'badgeMinRadius': instance.badgeMinRadius,
