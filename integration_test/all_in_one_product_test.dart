...
void main() {
  ...
  bool isGenerateEnabled(WidgetTester tester) {
    final btnWidget = tester.widget<ElevatedButton>(
      find.ancestor(
        of: find.textContaining('GENERATE'),
  ...
  group('1. Single Elimination', () {
    testWidgets(
      '1a. Renders 2, 3, 4, and 8-player tie sheets safely and tests post-generation actions',
      (tester) async {
        ...
        for (final count in [2, 3, 4, 8]) {
          ...
          expect(
            ...
            findsWidgets,
          ); // Still displays canvas after regeneration
  ...
  group('2. Double Elimination', () {
    testWidgets('2a. Renders 4 and 8-player brackets and tests Tab Switching', (
      tester,
    ) async {
      await startAppAndNavigateToSetup(tester);
  ...
  group('3. Tournament Info & Registration ID', () {
    testWidgets('3a. Tournament info form fill and roster verification', (
      tester,
    ) async {
      await startAppAndNavigateToSetup(tester);
      ...
      expect(
        find.widgetWithText(TextField, 'Registration ID (Optional)'),
        findsOneWidget,
      );
  ...
  group('4. Participant Management', () {
    testWidgets(
      '4a. Add, clear all, discrete removal, and generate validation',
      (tester) async {
        await startAppAndNavigateToSetup(tester);
  ...
  group('5. Advanced Settings Toggle', () {
    testWidgets('5a. Switch settings (Format, 3rd Place, Dojang)', (
      tester,
    ) async {
      await startAppAndNavigateToSetup(tester);
  ...
  group('6. Edge Cases', () {
    testWidgets(
      '6a. Non-power of 2 (5, 7) and strict reference (14) size brackets',
      (tester) async {
        await startAppAndNavigateToSetup(tester);
